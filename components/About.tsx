                ...
                <div className="relative h-full w-full flex flex-col lg:flex-row items-center justify-between xl:gap-10 lg:gap-4 md:gap-16 gap-10">
                    ...
                    <div className="flex items-center sm:items-start justify-center flex-col xl:w-[60%] lg:w-[58%]">
                        ...
                        <motion.p 
                            ...
                            className="text-center sm:text-start lg:text-xs md:text-[18px] text-[16px] font-light text-secondaryColor text-opacity-[0.3] xl:leading-5 lg:leading-[28px] leading-5 xl:tracking-widest lg:tracking-wide tracking-wider"
                        >
