    ...
    return (
        <section id="about" className="min-h-screen w-full xl:mb-16 scroll-mt-10">
            <div className="container relative">
                <div 
                    className="mt-10 md:mt-16 mt- mb-16"
                >
                    <motion.h2 
                ...
                <div className="relative h-full w-full flex flex-col lg:flex-row items-center justify-between xl:gap-10 lg:gap-4 md:gap-16 gap-10">
                    ...
                    <div className="flex items-start justify-center flex-col xl:w-[60%] lg:w-[58%]">
                        <motion.h2 
                            ...
                            className="relative xl:text-3xl lg:text-2xl md:text-3xl text-3xl font-semibold text-secondaryColor mb-3
                        ...
                        <motion.h3 
                            ...
                            className="xl:text-sm lg:text-xs text-sm lg:tracking-wider md:tracking-wide font-normal text-secondaryColor mb-2 text-opacity-[0.8]"
                        >
                        ...
                        <motion.p 
                            ...
                            className="lg:text-xs md:text-[18px] text-[20px] font-light text-secondaryColor text-opacity-[0.3] xl:leading-5 lg:leading-[28px] leading-5 xl:tracking-widest lg:tracking-wide tracking-wider"
                        >
